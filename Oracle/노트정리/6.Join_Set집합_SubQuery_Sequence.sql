...
-- JOB에 'A'문자열이 들어간 사원의 부서와 같은 곳에서 근무하는 사원의 부서이름 검색하고 싶다. 
 --1) JOB에 'A'문자열이 들어간 사원의 부서와 같은 곳에서 근무하는
  ...
  --  > ANY VS >ALL    / < ANY     < ALL
  SELECT DNAME FROM DEPT WHERE DEPTNO = ANY (SELECT DISTINCT DEPTNO FROM EMP WHERE JOB LIKE '%A%');
  
 -- 부서번호가 30인 사원들이 급여중에서 가장 많이 받는 사원보다 더 많이 받는 사원정보를 검색하고 싶다. 
   --1) 부서번호가 30인 사원들이 급여를 알아야 한다. 
   ...
   -- 부서번호가 30인 사원들의 급여중에서 가장 적게 받는 사원보다 더 적게 받는 사원정보를 검색하고 싶다.  
