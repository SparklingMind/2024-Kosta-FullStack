	...
	public void printMenu() {
		...
		while (true) {
			System.out.println(
					"----------------------------------------------------------------------------------------------------------");
			System.out.println(
					"1. 전체검색    2. 모델번호검색     3.등록     4. 수정   5. 삭제   6.오름차순 정렬   7.내림차순 정렬    8. 오늘의 랜덤 할인   9. 종료");
			System.out.println(
					"----------------------------------------------------------------------------------------------------------");
			...
			case "5":
				...
				break;
			case "6":
				controller.ascendingSortByPrice();
				break;
			case "7":
				controller.descendingSortByPrice();
				break;
			case "8":
				controller.randomDiscount();
				break;
			case "9":
